...
frappe.response["message"] = {
    ...
    `},this.scripts=[this.si6_accounting_data,this.si6_app_bootstrap,this.si6_guard_context,this.si6_portal_data,this.si6_reference_data,this.si6_fetch_required_documents,this.si6_create_required_documents],this.initialization=d({defaultValue:[],loader:async()=>{let i=[],t=await this.crudStore.list("Server Script",i,[],[],100),_=new Map(t.map(e=>[e.name,e]));for(let e of this.scripts){let s=_.get(e.name);if(!s){await this.crudStore.create("Server Script",e);continue}(s.script!==e.script||s.api_method!==e.api_method||s.script_type!==e.script_type)&&await this.crudStore.update("Server Script",s.name,{script:e.script,api_method:e.api_method,script_type:e.script_type})}return await this.crudStore.list("Server Script",i,[],[],100)}}),p(()=>{!this.initialization.isLoading()&&!this.initialization.error()&&this.router.navigateByUrl("/documents-preparation")})}static{this.\u0275fac=function(t){return new(t||a)}}static{this.\u0275cmp=m({type:a,selectors:[["app-initialization"]],decls:4,vars:0,consts:[[1,"relative","h-screen","flex","items-center","justify-center"],["src","assets/imgs/sic.svg","alt","Strategic Innovation Center",1,"absolute","top-0","w-1/4","opacity-75"]],template:function(t,_){t&1&&(o(0,"div",0),n(1,"img",1),o(2,"div"),n(3,"ion-spinner"),c()())},dependencies:[u],encapsulation:2,changeDetection:0})}}return a})();export{P as InitializationComponent};
