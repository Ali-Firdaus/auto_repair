...
frappe.response["message"] = {
    ...
    `},this.scripts=[this.si6_accounting_data,this.si6_app_bootstrap,this.si6_guard_context,this.si6_portal_data,this.si6_reference_data,this.si6_fetch_required_documents,this.si6_create_required_documents],this.initialization=c({defaultValue:[],loader:async()=>{let s=[],e=await this.crudStore.list("Server Script",s,[],[],100);return e.length&&await Promise.all(e.map(a=>this.crudStore.delete("Server Script",a.name))),await Promise.all(this.scripts.map(a=>this.crudStore.create("Server Script",a))),await this.crudStore.list("Server Script",s,[],[],100)}}),o(()=>{!this.initialization.isLoading()&&!this.initialization.error()&&this.router.navigateByUrl("/documents-preparation")})}static{this.\u0275fac=function(e){return new(e||t)}}static{this.\u0275cmp=_({type:t,selectors:[["app-initialization"]],decls:4,vars:0,consts:[[1,"relative","h-screen","flex","items-center","justify-center"],["src","assets/imgs/sic.svg","alt","Strategic Innovation Center",1,"absolute","top-0","w-1/4","opacity-75"]],template:function(e,a){e&1&&(r(0,"div",0),n(1,"img",1),r(2,"div"),n(3,"ion-spinner"),p()())},dependencies:[l],encapsulation:2,changeDetection:0})}}return t})();export{v as InitializationComponent};
