import{Bn as hl,D as Fr,Dn as et,E as Fh,Et as Rw,Fn as gh,G as Iw,I as Ho,It as Uh,Jt as YD,O as Fy,Pn as gd,Q as KD,Qt as Zh,Rt as Vh,St as Rh,Y as Js,Yt as YI,a as Ah,ci as xj,ct as N,f as D,fr as mw,ft as Oh,gi as yw,gr as oT,n as $i,o as Aj,p as Dg,ri as ww,tn as _D,ut as Nj,w as Ew}from"./chunk-XMMDyd3T.js";import{Et as gi,Jt as rt}from"./main-ADO3GQQL.js";import{Ct as re,Lt as h,Ot as at,Pt as A,ft as Ws,pt as Ye,rt as Hs}from"./chunk-D_XLG1di.js";import{t as m}from"./chunk-BPBE-o76.js";var Y=[`switch`];var J=[`*`];function K(i,p){i&1&&($i(0,`span`,11),gd(),$i(1,`svg`,13),Rh(2,`path`,14),hl(),$i(3,`svg`,15),Rh(4,`path`,16),hl()())}var ee=new N(`mat-slide-toggle-default-options`,{providedIn:`root`,factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})});var g=class{source;checked;constructor(p,t){this.source=p,this.checked=t}};var te=(()=>{class i{_elementRef=D(Fr);_focusMonitor=D(Ye);_changeDetectorRef=D(Nj);defaults=D(ee);_onChange=t=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(t){return new g(this,t)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=at();_focused=!1;name=null;id;labelPosition=`after`;ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(t){this._checked=t,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new et;toggleChange=new et;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){D(h).load(Ws);let t=D(new Dg(`tabindex`),{optional:!0}),a=this.defaults;this.tabIndex=t==null?0:parseInt(t)||0,this.color=a.color||`accent`,this.id=this._uniqueId=D(re).getId(`mat-mdc-slide-toggle-`),this.hideIcon=a.hideIcon??!1,this.disabledInteractive=a.disabledInteractive??!1,this._labelId=this._uniqueId+`-label`}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(t=>{t===`keyboard`||t===`program`?(this._focused=!0,this._changeDetectorRef.markForCheck()):t||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(t){t.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(t){this.checked=!!t}registerOnChange(t){this._onChange=t}registerOnTouched(t){this._onTouched=t}validate(t){return this.required&&t.value!==!0?{required:!0}:null}registerOnValidatorChange(t){this._validatorOnChange=t}setDisabledState(t){this.disabled=t,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new g(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static ɵfac=function(a){return new(a||i)};static ɵcmp=_D({type:i,selectors:[[`mat-slide-toggle`]],viewQuery:function(a,e){if(a&1&&Uh(Y,5),a&2){let l;Iw(l=Ew())&&(e._switchElement=l.first)}},hostAttrs:[1,`mat-mdc-slide-toggle`],hostVars:15,hostBindings:function(a,e){a&2&&(Fh(`id`,e.id),Ah(`tabindex`,null)(`aria-label`,null)(`name`,null)(`aria-labelledby`,null),Rw(e.color?`mat-`+e.color:``),Zh(`mat-mdc-slide-toggle-focused`,e._focused)(`mat-mdc-slide-toggle-checked`,e.checked)(`mat-slide-toggle-full-width`,e.fullWidth)(`_mat-animation-noopable`,e._noopAnimations))},inputs:{name:`name`,id:`id`,labelPosition:`labelPosition`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],required:[2,`required`,`required`,xj],color:`color`,disabled:[2,`disabled`,`disabled`,xj],fullWidth:[2,`fullWidth`,`fullWidth`,xj],disableRipple:[2,`disableRipple`,`disableRipple`,xj],tabIndex:[2,`tabIndex`,`tabIndex`,t=>t==null?0:Aj(t)],checked:[2,`checked`,`checked`,xj],hideIcon:[2,`hideIcon`,`hideIcon`,xj],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,xj]},outputs:{change:`change`,toggleChange:`toggleChange`},exportAs:[`matSlideToggle`],features:[oT([{provide:rt,useExisting:Ho(()=>i),multi:!0},{provide:gi,useExisting:i,multi:!0}]),Fy],ngContentSelectors:J,decls:14,vars:27,consts:[[`switch`,``],[`mat-internal-form-field`,``,3,`labelPosition`],[`role`,`switch`,`type`,`button`,1,`mdc-switch`,3,`click`,`tabIndex`,`disabled`],[1,`mat-mdc-slide-toggle-touch-target`],[1,`mdc-switch__track`],[1,`mdc-switch__handle-track`],[1,`mdc-switch__handle`],[1,`mdc-switch__shadow`],[1,`mdc-elevation-overlay`],[1,`mdc-switch__ripple`],[`mat-ripple`,``,1,`mat-mdc-slide-toggle-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-switch__icons`],[1,`mdc-label`,3,`click`,`for`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--on`],[`d`,`M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--off`],[`d`,`M20 13H4v-2h16v2z`]],template:function(a,e){if(a&1&&(mw(),$i(0,`div`,1)(1,`button`,2,0),Vh(`click`,function(){return e._handleClick()}),Rh(3,`div`,3)(4,`span`,4),$i(5,`span`,5)(6,`span`,6)(7,`span`,7),Rh(8,`span`,8),hl(),$i(9,`span`,9),Rh(10,`span`,10),hl(),YD(11,K,5,0,`span`,11),hl()()(),$i(12,`label`,12),Vh(`click`,function($){return $.stopPropagation()}),yw(13),hl()()),a&2){let l=ww(2);Oh(`labelPosition`,e.labelPosition),YI(),Zh(`mdc-switch--selected`,e.checked)(`mdc-switch--unselected`,!e.checked)(`mdc-switch--checked`,e.checked)(`mdc-switch--disabled`,e.disabled)(`mat-mdc-slide-toggle-disabled-interactive`,e.disabledInteractive),Oh(`tabIndex`,e.disabled&&!e.disabledInteractive?-1:e.tabIndex)(`disabled`,e.disabled&&!e.disabledInteractive),Ah(`id`,e.buttonId)(`name`,e.name)(`aria-label`,e.ariaLabel)(`aria-labelledby`,e._getAriaLabelledBy())(`aria-describedby`,e.ariaDescribedby)(`aria-required`,e.required||null)(`aria-checked`,e.checked)(`aria-disabled`,e.disabled&&e.disabledInteractive?`true`:null),YI(9),Oh(`matRippleTrigger`,l)(`matRippleDisabled`,e.disableRipple||e.disabled)(`matRippleCentered`,!0),YI(),KD(e.hideIcon?-1:11),YI(),Oh(`for`,e.buttonId),Ah(`id`,e._labelId)}},dependencies:[Hs,m],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})}return i})();var we=(()=>{class i{static ɵfac=function(a){return new(a||i)};static ɵmod=gh({type:i});static ɵinj=Js({imports:[te,A]})}return i})();export{we as n,te as t};