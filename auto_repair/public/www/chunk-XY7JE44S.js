...
frappe.response["message"] = {
    ...
    `};var Q=(()=>{class t{constructor(){this.crudStore=r(d),this.router=r(l),this.scripts=[u,f,h,v,b,w,g,y,E,S],this.initialization=c({defaultValue:[],loader:async()=>{let s=[],e=await this.crudStore.list("Server Script",s,[],[],100);return e.length&&await Promise.all(e.map(a=>this.crudStore.delete("Server Script",a.name))),await Promise.all(this.scripts.map(a=>this.crudStore.create("Server Script",a))),await this.crudStore.list("Server Script",s,[],[],100)}}),n(()=>{!this.initialization.isLoading()&&!this.initialization.error()&&this.router.navigateByUrl("/documents-preparation")})}static{this.\u0275fac=function(e){return new(e||t)}}static{this.\u0275cmp=p({type:t,selectors:[["app-initialization"]],decls:4,vars:0,consts:[[1,"relative","h-screen","flex","items-center","justify-center"],["src","assets/imgs/sic.svg","alt","Strategic Innovation Center",1,"absolute","top-0","w-1/4","opacity-75"]],template:function(e,a){e&1&&(i(0,"div",0),o(1,"img",1),i(2,"div"),o(3,"ion-spinner"),_()())},dependencies:[m],encapsulation:2,changeDetection:0})}}return t})();export{Q as InitializationComponent};
